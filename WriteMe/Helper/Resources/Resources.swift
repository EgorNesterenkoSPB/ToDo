...
enum Resources {
    ...
    static let firstMainOnBoardingText = "Thank you for downloading"
    static let firstSecondOnBoardingText = "Create and save tasks, write your personal blog, check productivity on charts"
