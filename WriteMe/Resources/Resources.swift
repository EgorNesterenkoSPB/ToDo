...
//    static let settingsContent:[Section] = [Section(title: "", options: [CommonCellOption(title: Resources.Titles.account, icon: UIImage(systemName: Resources.Images.profileImage), iconBackgroundColor: .gray, handler: {}),CommonCellOption(title: Resources.Titles.writeInSupport, icon: UIImage(systemName: Resources.Images.mail), iconBackgroundColor: .systemIndigo, handler: {})])]
    ...
    enum Titles {
        ...
        static let failedGetImage = NSLocalizedString("FAILED_GET_IMAGE", comment: "failed get image")
        static let failedSaveImage = NSLocalizedString("FAILED_TO_SAVE_IMAGE", comment: "failed to save image")
        static let failedChange = NSLocalizedString("FAILED_TO_CHANGE", comment: "failed to change")
        static let failedDeleteImage = NSLocalizedString("FAILED_TO_DELETE_IMAGE", comment: "failed to delete image")
        static let failedCreateNote = NSLocalizedString("FAILED_CREATE_NOTE", comment: "failed create note")
        static let failedDeleteNote = NSLocalizedString("FAILED_DELETE_NOTE", comment: "failed delete note")
        static let failedLoadData = NSLocalizedString("FAILED_LOAD_DATA", comment: "failed load data")
        ...
        static let incomingProjectErrorMessage = NSLocalizedString("INCOMING_PROJECT_FOUND_ERROR", comment: "incoming project error message")
        static let albumErrorMessage = NSLocalizedString("ALBUM_OPEN_ERROR", comment: "album error message")
        static let settingsAskMessage = NSLocalizedString("ASK_SETTINGS_MESSAGE", comment: "settings ask message")
        static let cameraAccessIsDeneid = NSLocalizedString("CAMERA_ACCESS_IS_DENIED", comment: "camera access error")
        static let closeImage = NSLocalizedString("CLOSE_IMAGE", comment: "close image button")
    }
    enum Placeholders {
