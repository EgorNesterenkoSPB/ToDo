...
enum Resources {
    ...
    static let projectsModels:[CommonCellOption] = [CommonCellOption(title: "Incoming", icon: UIImage(systemName: Resources.Images.incoming,withConfiguration: Resources.Configurations.largeConfiguration), iconBackgroundColor: UIColor.blue, handler: {}), CommonCellOption(title: "Upcoming", icon: UIImage(systemName: Resources.Images.calendar,withConfiguration: Resources.Configurations.largeConfiguration), iconBackgroundColor: UIColor.purple, handler: {}), CommonCellOption(title: "My blog", icon: UIImage(systemName: Resources.Images.folderFill, withConfiguration: Resources.Configurations.largeConfiguration), iconBackgroundColor: UIColor.systemIndigo, handler: {})]
